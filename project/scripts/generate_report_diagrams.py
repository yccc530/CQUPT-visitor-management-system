...
def system_architecture():
    ...
    c.process((860,560,1240,680),'运行界面截图\n核心页面 / 业务结果')
    c.process((1580,560,1940,680),'设计与截图资料\nE-R 图 / 数据流程图 / 界面截图')
    c.process((860,850,1240,970),'课程设计报告\n系统设计 / SQL / 测试截图')
    c.line((520,300),(860,300),label='HTTP API')
    c.line((1240,300),(1580,300),label='SQL')
    c.line((1050,560),(1050,360),label='访问页面')
    c.line((1240,620),(1580,620),label='整理材料')
    c.line((1760,680),(1240,910),label='整理引用')
