...
TABLE_DISPLAY_NAMES = {
    ...
    'campus_gate': '校门表',
    'visitor': '访客表',
    'visitor_vehicle': '访客车辆表',
    'visitor_companion': '随行人员表',
    'visit_apply': '预约申请表',
    'approval_record': '审批记录表',
    'pass_code': '通行凭证表',
    'access_record': '出入校记录表',
    'blacklist': '黑名单表',
    'notice': '通知消息表',
    'operation_log': '操作日志表',
    'dict_type': '字典类型表',
    'dict_item': '字典项表',
    'screenshot_record': '截图记录表',
    'report_record': '报告记录表',
}
...
# 03 system design
summary_rows = [[TABLE_DISPLAY_NAMES.get(name, name), field_list(schema_sql, name), '\u6570\u636e\u5e93\u7269\u7406\u8868\uff0c\u4e0e\u5173\u7cfb\u6a21\u5f0f\u548c\u7cfb\u7edf\u5b9e\u73b0\u5bf9\u8c61\u5bf9\u5e94'] for name in schema_tables]
chapter03 = r'''
\section{系统设计}
\subsection{本章概述}
...
chapter03 += table('主要实体及存在原因', ['实体', '存在原因'], [
    ...
    ['系统用户', 'sys_user 保存登录账号、真实姓名、联系方式和所属部门。'],
    ['角色', 'sys_role 保存系统角色及角色状态。'],
    ['权限', 'sys_permission 保存菜单权限、接口权限和父子权限结构。'],
