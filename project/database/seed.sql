...
(3, 'apply:mine', '我的预约', 'MENU', NULL, '/visit/mine', 'views/visit/mine.vue', '/api/workflow/visit-applies/my', 3, 'ENABLED'),
(4, 'confirm:host', '待确认预约', 'MENU', NULL, '/approval/host', 'views/approval/host.vue', '/api/workflow/host/pending', 4, 'ENABLED'),
(5, 'approval:department', '部门审批', 'MENU', NULL, '/approval/department', 'views/approval/department.vue', '/api/workflow/department/pending', 5, 'ENABLED'),
(6, 'gate:verify', '门岗核验', 'MENU', NULL, '/gate/verify', 'views/gate/verify.vue', '/api/workflow/gate/verify', 6, 'ENABLED'),
...
(10, 'access:overtime', '超时未离校访客', 'MENU', NULL, '/access/overtime', 'views/access/overtime.vue', '/api/workflow/access/overtime', 10, 'ENABLED'),
...
(3, 1, 'PENDING_DEPT', '待部门审批', 'PENDING_DEPT', 3, 'ENABLED', '兼容历史测试数据'),
